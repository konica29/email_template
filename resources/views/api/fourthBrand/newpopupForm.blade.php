<form class="form" id="popup-fourth" name="popup-fourth" method="post" action="/thank-you">
    ...
    <div class="input-container">
        ...
        <div class="phonecode-field">
            ...
            <input type="number" onfocusout="removeValidations(this)" class="telephone" id="phoneMain" placeholder="Phone No.*" autocomplete="nope">
    ...
    <div class="input-container company-input">
        <label for="emailOther" id="labelEmail"><img src="{{ url('img/star.svg') }}" alt=""> Company email</label>
        <input type="email" name="kyht" id="emailOther" placeholder="" autocomplete="nope"
    ...
    <div class="form-consent">
        <input type="checkbox" id="Consent1" name="contactConsent">
        <label for="Consent1">By submitting this enquiry, I agree to be contacted in the most suitable
    ...
    <div class="form-consent">
        <input type="checkbox" id="checkConsentOther1" name="marketing_consent">
        <label for="checkConsentOther1">I wish to sign up to our email marketing, offers and discounts</label>
    </div>
    <div class="buttons">
