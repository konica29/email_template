<form action="/thank-you" id="popup-second" name="popup-second" class="form" onSubmit="checkFields(this)">
    ...
    <div class="form-consent">
        <input type="checkbox" id="Consent3" name="contactConsent">
        <label for="Consent3">By submitting this enquiry, I agree to be contacted in the most suitable
