<form class="form" id="other-third" name="other-third" method="POST" action="/thank-you">
    ...
    <div class="form-input">
        ...
        <div class="input-container">
            <div class="phonecode-field">
                ...
                <input type="number" class="telephone" id="phonePopup" placeholder="Phone Number*" autocomplete="nope">
