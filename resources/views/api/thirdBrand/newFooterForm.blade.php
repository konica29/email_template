<form class="form" id="other-third" name="other-third" method="post" onSubmit="checkFields(this)" action="/thank-you" data-hs-cf-bound="true">
    ...
    <div class="heading white-heading">
            ...
            <h2>Have Questions?<br> Complete the Form Below!</h2>
    ...
    <div class="input-container">
        <label for=""> <img src="https://theenquiry.co.uk/img/star.svg" alt=""> Full Name</label>
        <input type="text" onfocusout="removeValidations(this)" name="jyth" id="nameOther" autocomplete="nope">
    </div>
    <div class="input-container">
        <label for=""> <img src="https://theenquiry.co.uk/img/star.svg" alt=""> Phone number</label>
        <div class="phonecode-field">
           
            <select class="country-code"></select>
            <span class="prefix">+44</span>
            <input type="number" class="telephone" onfocusout="removeValidations(this)" id="phoneMain" placeholder="Phone No.*" autocomplete="nope">
    ...
    <div class="input-container company-input">
        <label for="emailOther" id="labelEmail"><img src="https://theenquiry.co.uk/img/star.svg" alt=""> Company email</label>
    ...
    <div class="checkEmail" style="display: none;">
        ...
        <div class="input-container company-input">
            <label for=""> <img src="https://theenquiry.co.uk/img/star.svg" alt=""> Company website</label>
            <input type="text"  name="company" autocomplete="nope" onfocusout="validateURL(this)">
        </div>
    </div>
    <div class="input-container company-job">
        <label for=""> <img src="https://theenquiry.co.uk/img/star.svg" alt=""> Job title</label>
